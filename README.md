...
| 02 | [⚙️ Initialization Deep Learning](#%EF%B8%8F-2-initialization-deep-learning) | Deep Learning Fundamentals | Zero, Random, He Init | NumPy |
...
| 07 | [🌧️ Rain Prediction in Australia](#%EF%B8%8F-7-rain-prediction-in-australia) | Classical ML | EDA, Feature Eng, Classification | Sklearn, Pandas |
| 08 | [🖼️ Convolutional Neural Network](#%EF%B8%8F-8-convolutional-neural-network-application) | Computer Vision | Conv layers, Pooling, Filters | TensorFlow/Keras |
| 09 | [✂️ Image Segmentation (U-Net V2)](#%EF%B8%8F-9-image-segmentation-u-net-v2) | Computer Vision | Encoder-Decoder, Skip Connections | TensorFlow/Keras |
...
### ⚙️ 2. Initialization Deep Learning
...
| Random Init | Exploding/vanishing gradients | ⚠️ Small networks |
...
### 🌧️ 7. Rain Prediction in Australia
...
### 🖼️ 8. Convolutional Neural Network Application
...
### ✂️ 9. Image Segmentation — U-Net V2
...
────────────────────           ───────────────────────         ──────────────────────
✅ Neural nets from scratch    ✅ CNNs & image segmentation    ✅ Transformers & LLMs
✅ Optimization algorithms     ✅ Transfer learning            ✅ RAG & vector search
✅ Regularization              ✅ Face recognition             ✅ Agentic frameworks
✅ Gradient checking           ✅ Sign language detection      ✅ Multi-agent systems
✅ Classical ML + EDA          ✅ Object classification        🔄 CGEV thesis (ongoing)
```
